...
function Header()
{
    ...
    $this->SetXY(68,18);
    $this->Cell(80,10,'Historial del registro de articulos',1,0,'C',1);
    $this->SetXY(10,17);
...
require '../../pdf/cn.php';
$consulta = "SELECT * FROM trig_articulo";
...
$pdf->SetTextColor(255, 255, 255);
    ...
    $pdf->SetFillColor(51, 122, 183);
    $pdf->SetTextColor(255, 255, 255);
    $pdf->Cell(120, 10, utf8_decode('Acción ejecutada'), 1, 0, 'C', 1);
    $pdf->SetFillColor(51, 122, 183);
    $pdf->SetTextColor(255, 255, 255);
...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->Cell(120, 5, utf8_decode($row['accion']), 1, 0, 'C', 0);
    $pdf->SetTextColor(0, 0, 0);

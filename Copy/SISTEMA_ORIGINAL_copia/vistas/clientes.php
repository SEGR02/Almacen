			...
			<div class="row">
				<div class="col-sm-3">
					<form id="frmClientes">
						...
						<label>Email</label>
						<input type="email" class="form-control input-sm" id="email" name="email" pattern=".+@globex\.com" required>
						<label>Telefono</label>
						<input type="number" class="form-control input-sm" id="telefono" name="telefono">
						<label>Rif</label>
						<input type="text" class="form-control input-sm" id="rif" name="rif">
						<p></p>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="frmClientesU">
							...
							<label>Rif</label>
							<input type="text" class="form-control input-sm" id="rifU" name="rifU">
						</form>
					</div>
